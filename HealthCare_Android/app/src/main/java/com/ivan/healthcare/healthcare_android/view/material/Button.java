...
public abstract class Button extends CustomView {
	...
	public Button(Context context, AttributeSet attrs) {
		...
		clickAfterRipple = attrs.getAttributeBooleanValue(MATERIALDESIGNXML, "clickAfterRipple", false);
		setAttributes(attrs);
	...
	public Bitmap makeCircle() {
		Bitmap output = Bitmap.createBitmap(
				getWidth() - AppContext.dp2px(6), getHeight()
						- AppContext.dp2px(7), Config.ARGB_8888);
